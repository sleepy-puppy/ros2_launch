...
def parse_args():
    ...
    parser.add_argument("--detection_dir", help="Path to custom detections. Defaults to standard MOT detections Directory structure should be the default MOTChallenge structure: [sequence]/det/det.txt", default=None)
